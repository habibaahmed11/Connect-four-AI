...
def evaluate_window(window, piece):
    ...
    if window.count(piece) == 4:
        ...
        score += 2
    elif window.count(piece) == 2 and window.count("EMPTY") == 1 and window.count(opp_piece) == 1:
        score += 5
    ...
    if window.count(opp_piece) == 4:
        ...
        score -= 2
    elif window.count(opp_piece) == 2 and window.count("EMPTY") == 1 and window.count(piece) == 1:
        score -= 6
